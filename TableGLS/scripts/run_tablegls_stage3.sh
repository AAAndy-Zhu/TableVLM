...
STAGE2_FILE="${STAGE2_FILE:-${ROOT_DIR}/outputs/${MODEL_TYPE}/tablegls_stage2.jsonl}"
ANSWERS_FILE="${ANSWERS_FILE:-${ROOT_DIR}/outputs/${MODEL_TYPE}/tablegls_stage3.jsonl}"
...
python "${SRC_DIR}/eval_mmtab_vllm_tablegls_stage3.py" \
