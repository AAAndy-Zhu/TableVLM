...
STAGE1_FILE="${STAGE1_FILE:-${ROOT_DIR}/outputs/${MODEL_TYPE}/tablegls_stage1.jsonl}"
ANSWERS_FILE="${ANSWERS_FILE:-${ROOT_DIR}/outputs/${MODEL_TYPE}/tablegls_stage2.jsonl}"
...
python "${SRC_DIR}/eval_mmtab_vllm_tablegls_stage2.py" \
